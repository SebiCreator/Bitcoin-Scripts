...
expected_output1= {
    ...
    "vout": [
        {
            "address": "1Agqtbn3xVXzpzUbnVKyuMFq64WJGXPiAw",
            "scriptPubKey": {
                "asm": "OP_DUP OP_HASH160 6a422a63e77af3560ea133ce377604766a6980ef OP_EQUALVERIFY OP_CHECKSIG",
                "hex": "76a9146a422a63e77af3560ea133ce377604766a6980ef88ac",
                "mode": "P2PKH"
            },
            "value": 0.1
        },
        {
            "address": "1BWV276jbt566HzUGX63RNewXvKtd3GaXH",
            "scriptPubKey": {
                "asm": "OP_DUP OP_HASH160 7344b5b94753bc2ee1bf87aadbf757864d92d06d OP_EQUALVERIFY OP_CHECKSIG",
                "hex": "76a9147344b5b94753bc2ee1bf87aadbf757864d92d06d88ac",
                "mode": "P2PKH"
            },
            "value": 0.9023089
        }
...
expected_output2= {
    ...
    "vout": [
        {
            "address": "1Bet56kWEpCq8ugG9tqAkLNXqaAQ4eUALp",
            "scriptPubKey": {
                "asm": "OP_DUP OP_HASH160 74db47b3163a0acd36a85b269f2dfc0fee9cc91c OP_EQUALVERIFY OP_CHECKSIG",
                "hex": "76a91474db47b3163a0acd36a85b269f2dfc0fee9cc91c88ac",
                "mode": "P2PKH"
            },
            "value": 0.05
        },
        {
            "address": "1BoUDwRh4Spnd2pGbuAWKcBbix5mXAnnGL",
            "scriptPubKey": {
                "asm": "OP_DUP OP_HASH160 767b1de3eb8688cb46bd1e8abb43627cffb668eb OP_EQUALVERIFY OP_CHECKSIG",
                "hex": "76a914767b1de3eb8688cb46bd1e8abb43627cffb668eb88ac",
                "mode": "P2PKH"
            },
            "value": 0.01006204
        }
